...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Extração de relatórios do SIGC da PNDS 2022(3)",
    Description = "Funções e scripts para realizar download automatizados de relatórios da PNDS 2022 (realizada em 2023/4).",
    `Authors@R` = c(
      person("Eduardo", "Leoni", email = "e.leoni@gmail.com", role = c("aut", "cre"), comment = c(ORCID = "0000-0003-0955-5232"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Eduardo Leoni")
```
